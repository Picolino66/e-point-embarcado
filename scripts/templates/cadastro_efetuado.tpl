...
SUCESSO!
			...
			<div>
				<form action="/" method="POST" class="bloco" align="center">
					<div>
						<button type="submit" class="button" style="font-size:15px">CADASTRAR NOVAMENTE</button>
					</div>
				</form>
				<form action="/server_off" method="GET" class="bloco" align="center">
					<div>
